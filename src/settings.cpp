...
static void FixRange(unsigned int *value, unsigned int min_value,
		unsigned int max_value, unsigned int def_value);

/** Initialize settings. */
void Setting::InitializeSettings(void) {
...
void Setting::StartupSettings(void) {
...
void FixRange(unsigned int *value, unsigned int min_value,
		unsigned int max_value, unsigned int def_value) {
...
void Setting::SetTitleButtonOrder(const char *order) {
	unsigned i = 0;
