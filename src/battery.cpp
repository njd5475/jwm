...
void Battery::Draw() {
	...
	if (strWidth == this->getRequestedWidth()) {
		Fonts::RenderString(this->getPixmap(), FONT_CLOCK, COLOR_CLOCK_FG, (this->getWidth() - strWidth) / 2,
				(this->getHeight() - Fonts::GetStringHeight(FONT_CLOCK)) / 2, this->getWidth(), buf);
