...
static void ReplaceSymbol(char **str, unsigned int offset, const char *name,
    const char *value);
...
void ReplaceSymbol(char **str, unsigned int offset, const char *name,
    const char *value) {
